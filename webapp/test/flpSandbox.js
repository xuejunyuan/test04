		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "test04 App Title",
									"targetURL": "#btptest04test04-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"btptest04test04-display": {
								"semanticObject": "btptest04test04",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=btp.test04.test04",
									"url": sap.ui.require.toUrl("btp/test04/test04")
								}
							}
						}
					}
